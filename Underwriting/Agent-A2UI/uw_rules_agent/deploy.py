...
AGENT_RESOURCE_NAME = "projects/146646146609/locations/us-central1/reasoningEngines/4573186069024997376"

vertexai.init(project=PROJECT, location=LOCATION, staging_bucket=BUCKET_URI)

from uw_rules_agent.agent import root_agent
...
CONFIG = dict(
    ...
    display_name="Underwriting_UW_Rules_Agent",
