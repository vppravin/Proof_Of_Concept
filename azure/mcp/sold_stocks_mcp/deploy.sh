...
# Sold Stocks MCP Deployment Script

set -e

echo "🚀 Starting Sold Stocks MCP Deployment..."
echo ""
...
IMAGE_NAME="sold-stocks-mcp"
IMAGE_TAG="v1"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="sold-stocks-mcp"
...
echo "✅ Sold Stocks MCP deployed successfully!"
echo ""
