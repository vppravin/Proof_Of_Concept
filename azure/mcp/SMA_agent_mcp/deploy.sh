...
# SMA Agent MCP Deployment Script

set -e

echo "🚀 Starting SMA Agent MCP Deployment..."
echo ""
...
IMAGE_NAME="sma-agent-mcp"
IMAGE_TAG="v5"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="sma-agent-mcp"
...
echo "✅ SMA Agent MCP deployed successfully!"
echo ""
