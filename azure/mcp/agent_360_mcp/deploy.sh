...
# Agent 360 MCP Deployment Script

set -e

echo "🚀 Starting Agent 360 MCP Deployment..."
echo ""
...
IMAGE_NAME="agent-360-mcp"
IMAGE_TAG="v3"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="agent-360-mcp"
...
if az containerapp show --name ${CONTAINER_APP_NAME} --resource-group ${RESOURCE_GROUP} &>/dev/null; then
    ...
    az containerapp create \
        ...
        --env-vars \
            ...
            BLOB_CONTAINER=360-reports \
            APP_BASE_URL=https://agent-360-mcp.livelybay-96634f40.eastus2.azurecontainerapps.io
...
echo "✅ Agent 360 MCP deployed successfully!"
echo ""
