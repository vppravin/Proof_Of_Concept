...
# Comparison Leads MCP Deployment Script

set -e

echo "🚀 Starting Comparison Leads MCP Deployment..."
echo ""
...
IMAGE_NAME="comparison-leads-mcp"
IMAGE_TAG="v1"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="comparison-leads-mcp"
...
echo "✅ Comparison Leads MCP deployed successfully!"
echo ""
