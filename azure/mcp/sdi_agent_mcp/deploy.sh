...
# SDI Agent MCP Deployment Script
# This script builds, pushes, and deploys the SDI Agent MCP to Azure Container Apps

set -e  # Exit on any error

echo "🚀 Starting SDI Agent MCP Deployment..."
echo ""
...
IMAGE_NAME="sdi-agent-mcp"
IMAGE_TAG="v2"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="sdi-agent-mcp"
...
echo ""
echo "✅ SDI Agent MCP deployed successfully!"
echo ""
