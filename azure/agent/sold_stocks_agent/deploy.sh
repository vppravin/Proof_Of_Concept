...
# Sold Stocks Agent Deployment Script

set -e

echo "🚀 Starting Sold Stocks Agent Deployment..."
echo ""
...
IMAGE_NAME="sold-stocks-agent"
IMAGE_TAG="v2"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="sold-stocks-agent"
...
if az containerapp show --name ${CONTAINER_APP_NAME} --resource-group ${RESOURCE_GROUP} &>/dev/null; then
    ...
    az containerapp create \
        ...
        --env-vars \
            ...
            MCP_SERVER_URL=https://sold-stocks-mcp.livelybay-96634f40.eastus2.azurecontainerapps.io/mcp
...
echo "✅ Sold Stocks Agent deployed successfully!"
echo ""
...
echo "  curl -X POST https://${APP_URL}/query -H 'Content-Type: application/json' -d '{\"query\": \"Analyze sold stocks for Peter Griffin\"}'"
echo ""
