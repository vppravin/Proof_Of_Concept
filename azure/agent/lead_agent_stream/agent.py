...
logging.basicConfig(
    level=logging.INFO,
    format='%(asctime)s - [LEAD_AGENT_STREAM] - %(levelname)s - %(message)s'
)
...
After fetching, present leads sorted by Annual Revenue descending in a markdown table:

| # | Name | Annual Revenue | Lead Source | Email | Address |
|---|------|---------------|-------------|-------|---------|
| 1 | [Name] | $[value with commas] | [value] | [value] | [city, state] |

After the table end with:
**Total: [N] leads | Highest Revenue: $[value]**"""
