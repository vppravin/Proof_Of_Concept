...
# SDI Agent Deployment Script
# This script builds, pushes, and deploys the SDI Agent to Azure Container Apps

set -e  # Exit on any error

echo "🚀 Starting SDI Agent Deployment..."
echo ""
...
IMAGE_NAME="sdi-agent"
IMAGE_TAG="v12"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="sdi-agent"
...
if az containerapp show --name ${CONTAINER_APP_NAME} --resource-group ${RESOURCE_GROUP} &>/dev/null; then
    ...
    az containerapp create \
        ...
        --env-vars \
            ...
            MCP_SERVER_URL=https://sdi-agent-mcp.livelybay-96634f40.eastus2.azurecontainerapps.io/mcp

    echo ""
    echo "⚠️  IMPORTANT: Manually add AZURE_OPENAI_API_KEY environment variable via Azure Portal"
fi
...
echo ""
echo "✅ SDI Agent deployed successfully!"
echo ""
...
echo "  curl -X POST https://${APP_URL}/query -H 'Content-Type: application/json' -d '{\"query\": \"Show SDI summary for Peter Griffin\"}'"
echo ""
