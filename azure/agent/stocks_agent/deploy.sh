...
# Stocks Agent Deployment Script

set -e

echo "🚀 Starting Stocks Agent Deployment..."
echo ""
...
IMAGE_NAME="stocks-agent"
IMAGE_TAG="v2"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="stocks-agent"
...
if az containerapp show --name ${CONTAINER_APP_NAME} --resource-group ${RESOURCE_GROUP} &>/dev/null; then
    ...
    az containerapp create \
        ...
        --env-vars \
            ...
            MCP_SERVER_URL=https://stocks-mcp.livelybay-96634f40.eastus2.azurecontainerapps.io/mcp
...
echo "✅ Stocks Agent deployed successfully!"
echo ""
...
echo "  curl -X POST https://${APP_URL}/query -H 'Content-Type: application/json' -d '{\"query\": \"What is the current price of Apple?\"}'"
echo ""
