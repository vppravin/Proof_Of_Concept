...
# Lead Agent Deployment Script
# This script builds, pushes, and deploys the Lead Agent to Azure Container Apps

set -e  # Exit on any error

echo "🚀 Starting Lead Agent Deployment..."
echo ""
...
IMAGE_NAME="lead-agent"
IMAGE_TAG="v1"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="lead-agent"
CONTAINER_ENV="wm-env"
LOCATION="eastus2"
KEY_VAULT_NAME="wm-secrets-vault"
...
echo ""
echo "✅ Lead Agent deployed successfully!"
echo ""
