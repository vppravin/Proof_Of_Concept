...
# Comparison Leads Agent Deployment Script

set -e

echo "🚀 Starting Comparison Leads Agent Deployment..."
echo ""
...
IMAGE_NAME="comparison-leads-agent"
IMAGE_TAG="v5"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="comparison-leads-agent"
...
if az containerapp show --name ${CONTAINER_APP_NAME} --resource-group ${RESOURCE_GROUP} &>/dev/null; then
    ...
    az containerapp create \
        ...
        --env-vars \
            ...
            MCP_SERVER_URL=https://comparison-leads-mcp.livelybay-96634f40.eastus2.azurecontainerapps.io/mcp
...
echo "✅ Comparison Leads Agent deployed successfully!"
echo ""
...
echo "  curl -X POST https://${APP_URL}/query -H 'Content-Type: application/json' -d '{\"query\": \"Compare Peter Griffin and Lana Brooks\"}'"
echo ""
