...
# SMA Agent Deployment Script

set -e

echo "🚀 Starting SMA Agent Deployment..."
echo ""
...
IMAGE_NAME="sma-agent"
IMAGE_TAG="v11"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="sma-agent"
...
if az containerapp show --name ${CONTAINER_APP_NAME} --resource-group ${RESOURCE_GROUP} &>/dev/null; then
    ...
    az containerapp create \
        ...
        --env-vars \
            ...
            MCP_SERVER_URL=https://sma-agent-mcp.livelybay-96634f40.eastus2.azurecontainerapps.io/mcp
...
echo "✅ SMA Agent deployed successfully!"
echo ""
...
echo "  curl -X POST https://${APP_URL}/query -H 'Content-Type: application/json' -d '{\"query\": \"Show SMA summary for Rahul Jain\"}'"
echo ""
