...
# Agent 360 Deployment Script

set -e

echo "🚀 Starting Agent 360 Deployment..."
echo ""
...
IMAGE_NAME="agent-360"
IMAGE_TAG="v2"
FULL_IMAGE="${REGISTRY_SERVER}/${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_APP_NAME="agent-360"
...
if az containerapp show --name ${CONTAINER_APP_NAME} --resource-group ${RESOURCE_GROUP} &>/dev/null; then
    ...
    az containerapp create \
        ...
        --env-vars \
            ...
            MCP_SERVER_URL=https://agent-360-mcp.livelybay-96634f40.eastus2.azurecontainerapps.io/mcp
...
echo "✅ Agent 360 deployed successfully!"
echo ""
...
echo "  curl -X POST https://${APP_URL}/query -H 'Content-Type: application/json' -d '{\"query\": \"Generate 360 report for Peter Griffin\"}'"
echo ""
