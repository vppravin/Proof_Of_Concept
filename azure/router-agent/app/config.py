...
AGENTS: list[AgentConfig] = [
    ...
    # lead-agent replaced by lead-agent-stream
    # AgentConfig(
    #     id="lead-agent",
    #     name="Salesforce Leads Agent",
    #     description=(
    #         "Fetches and prioritizes sales leads from Salesforce. "
    #         "Sorts by Annual Revenue, shows lead name, ID, source, email, and address."
    #     ),
    #     url=os.getenv("LEAD_AGENT_URL", "https://lead-agent.livelybay-96634f40.eastus2.azurecontainerapps.io"),
