...
AGENT_RESOURCE_NAME = "projects/146646146609/locations/us-central1/reasoningEngines/5943406255652470784"

vertexai.init(project=PROJECT, location=LOCATION, staging_bucket=BUCKET_URI)

from client_history_agent.agent import root_agent
...
CONFIG = dict(
    ...
    display_name="Underwriting_Client_History_Agent",
    description="Fetches, creates, and updates client history records stored as JSON in GCS",
    ...
    extra_packages=["./client_history_agent/"],
