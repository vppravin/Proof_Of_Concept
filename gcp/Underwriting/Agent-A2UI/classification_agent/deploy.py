...
AGENT_RESOURCE_NAME = "projects/146646146609/locations/us-central1/reasoningEngines/2783005217145225216"

vertexai.init(project=PROJECT, location=LOCATION, staging_bucket=BUCKET_URI)

from classification_agent.agent import root_agent
...
CONFIG = dict(
    ...
    display_name="Underwriting_Classification_Agent_v2",
    description="Classifies insurance submission documents as ACORD_125, ACORD_140, LOSS_RUN, EMAIL, or UNKNOWN via Gemini Flash",
    ...
    extra_packages=["./classification_agent/"],
