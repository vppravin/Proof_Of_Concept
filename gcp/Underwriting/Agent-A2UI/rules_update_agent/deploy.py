...
AGENT_RESOURCE_NAME = "projects/146646146609/locations/us-central1/reasoningEngines/855464576630652928"

vertexai.init(project=PROJECT, location=LOCATION, staging_bucket=BUCKET_URI)

from rules_update_agent.agent import root_agent
...
CONFIG = dict(
    ...
    display_name="Underwriting_Rules_Update_Agent",
    description="Manages underwriting business rules stored in Excel in GCS",
    requirements=["cloudpickle", "google-cloud-aiplatform", "pydantic", "google-adk", "google-genai>=1.69.0", "google-cloud-storage", "vertexai", "python-dotenv==1.2.1", "openpyxl"],
    extra_packages=["./rules_update_agent/"],
