...
AGENT_RESOURCE_NAME = ("projects/146646146609/"
    ...
    "reasoningEngines/611437316694605824")  # Set this after first deployment

# Replace with your service account email that has IAM permissions
SERVICE_ACCOUNT = os.getenv("SERVICE_ACCOUNT", "146646146609-compute@developer.gserviceaccount.com")
...
if AGENT_RESOURCE_NAME:
    try:
        ...
        remote_app = agent_engines.update(
            ...
            description="Multi-agent routing assistant that delegates to 11 specialized agents",
            requirements=[
                "cloudpickle",
