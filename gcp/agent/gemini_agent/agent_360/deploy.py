...
if AGENT_RESOURCE_NAME:
    try:
        ...
        remote_app = agent_engines.update(
            ...
            display_name=agent_360.root_agent.name,
            description="360 View Financial Analyzer with retry logic and logging",
            requirements=[
                "cloudpickle",
            ...
            extra_packages=["./agent_360/"],
            env_vars={
                "GOOGLE_CLOUD_AGENT_ENGINE_ENABLE_TELEMETRY": "true",
                "OTEL_INSTRUMENTATION_GENAI_CAPTURE_MESSAGE_CONTENT": "true",
                "MCP_SERVER_URL": "https://mcp-360agent-146646146609.us-central1.run.app/sse",
            },
        )
    except NotFound:
...
print(f"Display Name: agent_360.root_agent.name")
