...
import agent as sold_stocks_agent
...
AGENT_RESOURCE_NAME = ("projects/146646146609/"
    ...
    "reasoningEngines/7659915980180553728")  # Set this after first deployment

vertexai.init(project=PROJECT, location=LOCATION, staging_bucket=BUCKET_URI)

print("Wrapping agent for deployment...")
adk_app = AdkApp(agent=sold_stocks_agent.root_agent, enable_tracing=True)
...
if AGENT_RESOURCE_NAME:
    try:
        ...
        remote_app = agent_engines.update(
            ...
            display_name=sold_stocks_agent.root_agent.name,
            description="Sold Stocks Analyzer with retry logic and logging",
            requirements=[
                "cloudpickle",
            ...
            extra_packages=["./sold_stocks/"],
            env_vars={
                "GOOGLE_CLOUD_AGENT_ENGINE_ENABLE_TELEMETRY": "true",
                "OTEL_INSTRUMENTATION_GENAI_CAPTURE_MESSAGE_CONTENT": "true",
                "MCP_SERVER_URL": "https://mcp-soldstocks-146646146609.us-central1.run.app/sse",
            },
        )
    except NotFound:
...
print(f"Display Name: sold_stocks_agent.root_agent.name")
